...
## ----show-multishape-3d, echo = FALSE, out.width = "100%", fig.cap = "Multi-shape classification showing detected spheres (coral), cylinder (blue), and plane (green)."----
