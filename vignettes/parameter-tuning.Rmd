...
Successful shape detection in point clouds requires **proper parameter tuning**. This guide provides systematic approaches to optimize detection parameters for your specific data.
...
- **Precision**: What percentage of detected shapes are correct? (minimize false positives)
- **Recall**: What percentage of true shapes are detected? (minimize false negatives)
...
**Meaning:** Maximum perpendicular distance from ideal shape for point inclusion
...
2. **Start conservative**: High min_votes, tight ranges
...
| Data Type | min_votes | distance_threshold | max_iterations |
|-----------|-----------|-------------------|----------------|
...
- `vignette("sphere-detection")`
- `vignette("line-detection")`
