...
✅ **Gradient function** - When n > palette size and need smooth colors  
...
**Note:** If you request more colors than available, `hough_palette()` automatically cycles. Use `hough_palette_gradient()` for true interpolation.
